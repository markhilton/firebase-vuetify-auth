          ...
          createVNode(_component_v_list_item_content, null, {
            default: withCtx(function () { return [
              createVNode(_component_v_list_item_title, { class: "title" }, {
                default: withCtx(function () { return [
                  createVNode(_component_v_icon, { color: $options.appIconColor }, {
                    default: withCtx(function () { return [
                      createTextVNode(toDisplayString($options.appIcon), 1 /* TEXT */)
                    ]; }),
                    _: 1 /* STABLE */
                  }, 8 /* PROPS */, ["color"]),
              ...
              createVNode(_component_v_list_item_subtitle, null, {
                default: withCtx(function () { return [
                  createVNode("div", _hoisted_1$6, toDisplayString($options.appSubTitle), 1 /* TEXT */)
                ]; }),
                _: 1 /* STABLE */
              })
            ]; }),
...
var _hoisted_2$4 = /*#__PURE__*/createTextVNode(" Forgot Password? ");
var _hoisted_3$4 = /*#__PURE__*/createTextVNode(" Login ");
...
var _hoisted_1$4 = /*#__PURE__*/createTextVNode(" Register ");
...
var _hoisted_2$3 = /*#__PURE__*/createVNode("div", { class: "mb-5" }, " Enter registered user email address and we will send you a link to reset your password. ", -1 /* HOISTED */);
var _hoisted_3$3 = /*#__PURE__*/createTextVNode(" Email Password Reset Link ");
var _hoisted_4$3 = /*#__PURE__*/createTextVNode(" Email has been sent! ");
var _hoisted_5$3 = /*#__PURE__*/createTextVNode("Please check your inbox and follow the instructions in the email to reset your account password");
var _hoisted_6$2 = /*#__PURE__*/createTextVNode(" Login ");
...
function Id(a,b){if(a.forEach&&"function"==typeof a.forEach){ a.forEach(b,void 0); }else if(na(a)||"string"===typeof a){ w(a,b,void 0); }else { for(var c=Hd(a),d=Gd(a),e=d.length,f=0;f<e;f++){ b.call(void 0,d[f],c&&c[f],a); } }}function Jd(a,b){
var arguments$1 = arguments;
this.b={};this.a=[];this.c=0;var c=arguments.length;if(1<c){if(c%2){ throw Error("Uneven number of arguments"); }for(var d=0;d<c;d+=2){ this.set(arguments$1[d],arguments$1[d+1]); }}else if(a){ if(a instanceof Jd){ for(c=a.Y(),d=0;d<c.length;d++){ this.set(c[d],a.get(c[d])); } }else { for(d in a){ this.set(d,a[d]); } } }}k=Jd.prototype;k.W=function(){Kd(this);for(var a=[],b=0;b<this.a.length;b++){ a.push(this.b[this.a[b]]); }return a};k.Y=function(){Kd(this);return this.a.concat()};
...
function Je(){return "undefined"!==typeof l.WorkerGlobalScope&&"function"===typeof l.importScripts}function Ke(){return firebase$1$1.INTERNAL.hasOwnProperty("reactNative")?"ReactNative":firebase$1$1.INTERNAL.hasOwnProperty("node")?"Node":Je()?"Worker":"Browser"}function Le(){var a=Ke();return "ReactNative"===a||"Node"===a}function Me(){for(var a=50,b=[];0<a;){ b.push("1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ".charAt(Math.floor(62*Math.random()))),a--; }return b.join("")}
...
l.FormData;!Va(di,c)||e||d||f.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");f.forEach(function(g,h){this.a.setRequestHeader(h,g);},a);a.m&&(a.a.responseType=a.m);"withCredentials"in a.a&&a.a.withCredentials!==a.S&&(a.a.withCredentials=a.S);try{hi(a),0<a.g&&(a.u=ii(a.a),Uh(a.b,fi(a,"Will abort after "+a.g+"ms if incomplete, xhr2 "+a.u)),a.u?(a.a.timeout=a.g,a.a.ontimeout=q(a.Ma,a)):a.s=Ed(a.Ma,a.g,a)),Uh(a.b,fi(a,"Sending request")),a.i=!0,a.a.send(b),a.i=!1;}catch(g$1){Uh(a.b,
...
c&&firebase$1$1.INTERNAL.node&&firebase$1$1.INTERNAL.node.XMLHttpRequest;if(!c&&!Je()){ throw new t("internal-error","The XMLHttpRequest compatibility library was not found."); }this.f=void 0;Je()?this.f=new Vh(self):Le()?this.f=new Hi(c):this.f=new Fh;this.b=null;}var Ni,Dg="idToken",Ji=new Ze(3E4,6E4),Ki={"Content-Type":"application/x-www-form-urlencoded"},Li=new Ze(3E4,6E4),Mi={"Content-Type":"application/json"};function Oi(a,b){b?a.a["X-Firebase-Locale"]=b:delete a.a["X-Firebase-Locale"];}
...
function Xj(a){try{return firebase$1$1.app(a).auth().Ga()}catch(b){return []}}function Yj(a,b,c,d,e,f){this.s=a;this.g=b;this.b=c;this.f=f;this.c=d||null;this.i=e||null;this.l=this.u=this.C=null;this.h=[];this.m=this.a=null;}
...
function Tk(){var a=!Xe(K())&&Ie()?!0:!1,b=Te(),c=Pe();this.m=a;this.h=b;this.l=c;this.a={};Qk||(Qk=new Lk);a=Qk;try{this.g=!qe()&&cf()||!l.indexedDB?new a.a.F:new Ck(Je()?new Dk:new a.a.F);}catch(d){this.g=new Dk,this.h=!0;}try{this.i=new a.a.bb;}catch(d$1){this.i=new Dk;}this.v=new Dk;this.f=q(this.Yb,this);this.b={};}var Uk;function Vk(){Uk||(Uk=new Tk);return Uk}function Wk(a,b){switch(b){case "session":return a.i;case "none":return a.v;default:return a.g}}
...
function Im(a,b,c){this.J=[];this.l=a.apiKey;this.m=a.appName;this.s=a.authDomain||null;var d=firebase$1$1.SDK_VERSION?Oe(firebase$1$1.SDK_VERSION):null;this.a=new Ii(this.l,Ca(Da),d);a.emulatorConfig&&Pi(this.a,a.emulatorConfig);this.b=new Am(this.a);Jm(this,b[Dg]);Cm(this.b,b);M(this,"refreshToken",this.b.a);Km(this,c||{});H.call(this);this.R=!1;this.s&&Re()&&(this.i=Xl(this.s,this.l,this.m));this.S=[];this.h=null;this.u=Lm(this);this.aa=q(this.hb,this);var e=this;this.ya=null;this.Oa=function(f){e.wa(f.h);};
...
function Mm(a,b){a.$=b;Ri(a.a,firebase$1$1.SDK_VERSION?Oe(firebase$1$1.SDK_VERSION,a.$):null);}Im.prototype.Ga=function(){return Za(this.$)};function Pm(a,b){a.ba&&xd(a.ba,"frameworkChanged",a.Ba);(a.ba=b)&&nd(b,"frameworkChanged",a.Ba);}Im.prototype.hb=function(){this.u.b&&(this.u.stop(),this.u.start());};function Qm(a){try{return firebase$1$1.app(a.m).auth()}catch(b){throw new t("internal-error","No firebase.auth.Auth instance is available for the Firebase App '"+a.m+"'!");}}
...
function Dn(a,b,c){return xn(a,function(){return a.b.get(a.c,a.a).then(function(d){d&&b&&(d.authDomain=b);d&&c&&(d.emulatorConfig=c);return pn(d||{})})})}function xn(a,b){a.f=a.f.then(b,b);return a.f}function En(a){this.l=!1;M(this,"settings",new em);M(this,"app",a);if(S(this).options&&S(this).options.apiKey){ a=firebase$1$1.SDK_VERSION?Oe(firebase$1$1.SDK_VERSION):null,this.a=new Ii(S(this).options&&S(this).options.apiKey,Ca(Da),a); }else { throw new t("invalid-api-key"); }this.R=[];this.s=[];this.O=[];this.hb=firebase$1$1.INTERNAL.createSubscribe(q(this.zc,this));this.X=void 0;this.bc=firebase$1$1.INTERNAL.createSubscribe(q(this.Ac,this));Fn(this,null);this.i=new un(S(this).options.apiKey+":"+S(this).name);this.D=
...
"#ff0000";b.style.bottom="0px";b.style.left="0px";b.style.margin="0px";b.style.zIndex=1E4;b.style.textAlign="center";b.classList.add("firebase-emulator-warning");l.document.body.appendChild(b);});}k.Gc=function(a){this.J.push(a);Ri(this.a,firebase$1$1.SDK_VERSION?Oe(firebase$1$1.SDK_VERSION,this.J):null);this.dispatchEvent(new Mn(this.J));};k.Ga=function(){return Za(this.J)};k.yb=function(a){this.S===a||this.l||(this.S=a,this.a.b=this.S);};k.T=function(){return this.S};
...
k.Xc=function(a){if(!Re()){ return F(new t("operation-not-supported-in-this-environment")); }var b=this,c=ng(a.providerId),d=Qe(),e=null;(!Te()||Ie())&&S(this).options.authDomain&&a.isOAuthProvider&&(e=ek(S(this).options.authDomain,S(this).options.apiKey,S(this).name,"signInViaPopup",a,null,d,firebase$1$1.SDK_VERSION||null,null,null,this.T(),this.P));var f=ze(e,c&&c.ua,c&&c.ta);c=On(this).then(function(g){return Tl(g,f,"signInViaPopup",a,d,!!e,b.T())}).then(function(){return new D(function(g,h){b.na("signInViaPopup",
...
function to(a,b,c){var d=!1;try{this.b=c||firebase$1$1.app();}catch(g){throw new t("argument-error","No firebase.app.App instance is currently initialized.");}if(this.b.options&&this.b.options.apiKey){ c=this.b.options.apiKey; }else { throw new t("invalid-api-key"); }var e=this,f=null;try{f=this.b.auth().Ga();}catch(g$1){}try{d=this.b.auth().settings.appVerificationDisabledForTesting;}catch(g$2){}f=firebase$1$1.SDK_VERSION?Oe(firebase$1$1.SDK_VERSION,f):null;ko.call(this,c,a,b,function(){try{var g=e.b.auth().la();}catch(h){g=
...
(function(){if("undefined"!==typeof firebase$1$1&&firebase$1$1.INTERNAL&&firebase$1$1.INTERNAL.registerComponent){var a={ActionCodeInfo:{Operation:{EMAIL_SIGNIN:Af,PASSWORD_RESET:"PASSWORD_RESET",RECOVER_EMAIL:"RECOVER_EMAIL",REVERT_SECOND_FACTOR_ADDITION:Cf,VERIFY_AND_CHANGE_EMAIL:Bf,VERIFY_EMAIL:"VERIFY_EMAIL"}},Auth:En,AuthCredential:Bg,Error:t};Z(a,"EmailAuthProvider",Zg,[]);Z(a,"FacebookAuthProvider",Qg,[]);Z(a,"GithubAuthProvider",Sg,[]);Z(a,"GoogleAuthProvider",Ug,[]);Z(a,"TwitterAuthProvider",Wg,[]);
Z(a,"OAuthProvider",Pg,[V("providerId")]);Z(a,"SAMLAuthProvider",Og,[V("providerId")]);Z(a,"PhoneAuthProvider",lh,[Ao()]);Z(a,"RecaptchaVerifier",to,[X(V(),zo(),"recaptchaContainer"),W("recaptchaParameters",!0),Bo()]);Z(a,"ActionCodeURL",Jf,[]);Z(a,"PhoneMultiFactorGenerator",co,[]);firebase$1$1.INTERNAL.registerComponent({name:"auth",instanceFactory:function(b){b=b.getProvider("app").getImmediate();return new En(b)},multipleInstances:!1,serviceProps:a,instantiationMode:"LAZY",type:"PUBLIC"});firebase$1$1.INTERNAL.registerComponent({name:"auth-internal",
instanceFactory:function(b){b=b.getProvider("auth").getImmediate();return {getUid:q(b.getUid,b),getToken:q(b.nc,b),addAuthTokenListener:q(b.cc,b),removeAuthTokenListener:q(b.Pc,b)}},multipleInstances:!1,instantiationMode:"LAZY",type:"PRIVATE"});firebase$1$1.registerVersion("@firebase/auth","0.16.5");firebase$1$1.INTERNAL.extendNamespace({User:Im});}else { throw Error("Cannot find the firebase namespace; be sure to include firebase-app.js before this library."); }})();}).apply(typeof global !== 'undefined' ? global : typeof self !== 'undefined' ? self : typeof window !== 'undefined' ? window : {});
...
var firebase = !firebase$1$1.apps.length ? firebase$1$1.initializeApp(config) : firebase$1$1.app();
...
var _hoisted_2$2 = /*#__PURE__*/createVNode("div", { class: "display-1 grey--text mb-3" }, "Error!", -1 /* HOISTED */);
var _hoisted_3$2 = /*#__PURE__*/createTextVNode(" Back to Login ");
var _hoisted_4$2 = { key: 0 };
var _hoisted_5$2 = /*#__PURE__*/createVNode("div", { class: "display-1 grey--text mb-3" }, "Verification Required", -1 /* HOISTED */);
var _hoisted_6$1 = /*#__PURE__*/createTextVNode("mdi-account");
var _hoisted_7$1 = { key: 1 };
var _hoisted_8$1 = /*#__PURE__*/createVNode("div", { class: "display-1 grey--text mb-3" }, "Email sent!", -1 /* HOISTED */);
var _hoisted_9$1 = /*#__PURE__*/createTextVNode("mdi-email");
var _hoisted_10$1 = /*#__PURE__*/createVNode("div", { class: "grey--text text--darken-2 mb-7 body-2" }, [
...
var _hoisted_12$1 = /*#__PURE__*/createVNode("p", { class: "grey--text text--darken-2 mb-7 body-2" }, [
...
var _hoisted_18 = /*#__PURE__*/createTextVNode(" SignIn ");
          ...
          ($props.error)
            ...
            : (openBlock(), createBlock(Fragment, { key: 1 }, [
                ...
                createVNode("div", null, [
                  ...
                  (_ctx.emailSent)
                    ? (openBlock(), createBlock("div", _hoisted_7$1, [
                        _hoisted_8$1,
                        createVNode(_component_v_icon, {
                          size: "100",
                          color: "grey",
...
var script$1 = {
  ...
  methods: {
    ...
    loginWithGoogle: function loginWithGoogle() {
      var provider = new firebase$1$1.auth.GoogleAuthProvider();
...
var _hoisted_1$1 = /*#__PURE__*/createVNode("div", { class: "caption" }, "or login with", -1 /* HOISTED */);
var _hoisted_2$1 = /*#__PURE__*/createTextVNode("mdi-google");
var _hoisted_3$1 = /*#__PURE__*/createVNode("span", null, "Google Gmail Account", -1 /* HOISTED */);
var _hoisted_4$1 = /*#__PURE__*/createTextVNode("mdi-facebook");
var _hoisted_5$1 = /*#__PURE__*/createVNode("span", null, "Facebook Account", -1 /* HOISTED */);
var _hoisted_6 = /*#__PURE__*/createTextVNode("mdi-cellphone");
var _hoisted_7 = /*#__PURE__*/createVNode("span", null, "Text Message To Your Phone", -1 /* HOISTED */);
var _hoisted_8 = /*#__PURE__*/createVNode("div", { id: "recaptcha-container" }, null, -1 /* HOISTED */);
var _hoisted_9 = /*#__PURE__*/createTextVNode(" Enter Phone Number ");
var _hoisted_10 = /*#__PURE__*/createTextVNode(" Send Code ");
var _hoisted_11 = /*#__PURE__*/createTextVNode(" Enter Confirm Code ");
var _hoisted_12 = /*#__PURE__*/createTextVNode(" Confirm Code ");
...
var script = {
  ...
  methods: Object.assign({}, mapActions("auth", ["loginWithEmail", "registerUser", "signOut", "sendVerificationEmail"]),
    mapMutations("auth", ["SET_DIALOG_SHARE", "SET_DIALOG_CREATE_REPORT"]),
...
var _hoisted_3 = /*#__PURE__*/createTextVNode(" Sign In ");
var _hoisted_4 = /*#__PURE__*/createTextVNode(" Register ");
var _hoisted_5 = /*#__PURE__*/createTextVNode(" Reset Password ");
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  var _component_LoginWithProvider = resolveComponent("LoginWithProvider");
  var _component_v_card_actions = resolveComponent("v-card-actions");
  var _component_v_card = resolveComponent("v-card");
  var _component_v_container = resolveComponent("v-container");
  var _component_v_dialog = resolveComponent("v-dialog");
              ...
              default: withCtx(function () { return [
                ...
                (_ctx.emailVerificationRequired)
                  ? (openBlock(), createBlock("div", _hoisted_1, [
                      createVNode(_component_EmailVerification, {
                        ...
                        onSendEmail: _ctx.sendVerificationEmail,
                          ...
                          createVNode(_component_v_tab_item, { class: "pt-5" }, {
                            default: withCtx(function () { return [
                              createVNode(_component_Login, {
                                ...
                                "is-loading": _ctx.isLoading,
                                onCredentials: _ctx.loginWithEmail,
                            ...
                            ? (openBlock(), createBlock(_component_v_tab_item, {
                                ...
                                default: withCtx(function () { return [
                                  createVNode(_component_Register, {
                                    ...
                                    "is-loading": _ctx.isLoading,
                                    onRegistration: _ctx.registerUser
                ...
                (!_ctx.emailVerificationRequired)
                  ? (openBlock(), createBlock(_component_v_card_actions, { key: 2 }, {
                      default: withCtx(function () { return [
                        createVNode(_component_LoginWithProvider, {
                          google: _ctx.google,
