...
instanceFactory:function(b){b=b.getProvider("auth").getImmediate();return {getUid:q(b.getUid,b),getToken:q(b.nc,b),addAuthTokenListener:q(b.cc,b),removeAuthTokenListener:q(b.Pc,b)}},multipleInstances:!1,instantiationMode:"LAZY",type:"PRIVATE"});firebase$1$1.registerVersion("@firebase/auth","0.16.4");firebase$1$1.INTERNAL.extendNamespace({User:Im});}else { throw Error("Cannot find the firebase namespace; be sure to include firebase-app.js before this library."); }})();}).apply(typeof global !== 'undefined' ? global : typeof self !== 'undefined' ? self : typeof window !== 'undefined' ? window : {});
...
var script = {
  components: {
    ...
    LoginWith3rdPartyProvider: script$1,
  },
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("div", null, [
    createVNode(_component_v_dialog, {
      modelValue: _ctx.showGuard,
      "onUpdate:modelValue": _cache[3] || (_cache[3] = function ($event) { return (_ctx.showGuard = $event); }),
