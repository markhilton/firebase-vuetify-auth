...
const { initializeGuard, SET_PASSWORD_RESET_SCREEN_SHOWN, SET_AUTH_GUARD_DIALOG_SHOWN } = store
const {
  tab,
  config,
  isLoading,
...
const debug = computed(() => this.config.debug)
const currentRoute = computed(() => this.$route.path)
